...
async def botinfo(ctx):
    ...
    embed = discord.Embed(description="A reliable utility bot for your every use. Try sending `r!help` to see what I can do!",color=discord.Color.gold())
...
bot.run('ODY4Njk5ODM0NDYxMzQ3ODgw.YPzdxA.7ZfE4zHR8-gSOVBWd8lON-dSkbw')
